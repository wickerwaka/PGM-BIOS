...
- `SOUND_FLOW.md` — notes on how the 68000 queues sound commands and how the Z80 receives/dispatches them.
- `MMIO_AUDIT.md` — audit of MMIO addresses visible in the raw decompilation, including likely undocumented/under-documented addresses.
